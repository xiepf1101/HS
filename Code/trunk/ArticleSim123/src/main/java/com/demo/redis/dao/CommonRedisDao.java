...
public interface CommonRedisDao {
     ...
     * select 关键词
     */
    DefaultStringRedisConnection select(Integer dbId);
    
    /*
     * 根据指定库查询数据
     */
    List<String> selectToFind(Integer dbId, String key);
    
    /*
     * 根据指定库新增数据
     */
    boolean selectToSave(Integer dbId, String key, String value);
